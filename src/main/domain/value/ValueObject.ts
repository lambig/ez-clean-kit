...
export abstract class ValueObject<V extends ValueObject<V>> extends DomainObject<V> {
    ...
    abstract deepCopy(): V;
    abstract values(): (ValueObject<any> | DomainPrimitive<any, any> | DomainObjects<ValueObject<any> | DomainPrimitive<any, any>>)[];
}
...
export type ValueObjectProperties = ValueObject<any> | DomainPrimitive<any, any> | DomainObjects<ValueObject<any> | DomainPrimitive<any, any>>;